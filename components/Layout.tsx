        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[9px] font-bold text-white/50 tracking-[0.2em] uppercase mt-1">UNORC • UNOREP CORE</p>
            </div>
          </div>
          <div className="flex flex-col items-end">
            <div className="flex items-center gap-2 bg-[#D4AF37]/10 px-3 py-1 rounded-full border border-[#D4AF37]/20">
              <span className="w-2 h-2 bg-yellow-400 rounded-full animate-pulse"></span>
              <span className="text-[10px] font-black uppercase text-white tracking-widest">Sistema IA</span>
            </div>
            <p className="text-[8px] text-[#D4AF37] font-bold mt-1 uppercase">Google IA Studio Collab</p>
          </div>
        </div>
      </header>
      ...
      <footer className="py-10 px-6 bg-black text-white/40 border-t border-[#D4AF37]/20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-left">
            ...
            <p className="text-sm font-bold text-white mb-1">Dpto. Inteligencia Artificial UNOREP CORE</p>
            <p className="text-xs">Desarrollado en colaboración con Google IA Studio.</p>
            <p className="text-[9px] mt-4 font-bold text-[#D4AF37]/60 tracking-widest">PROYECTO UNIVERSITARIO • MICROEMPRESA UNORC</p>
          </div>
          <div className="text-left md:text-right text-[10px] font-medium leading-relaxed">
            ...
            <p className="text-[#D4AF37]">Tecnología de Inyección de Datos de Alta Fidelidad.</p>
          </div>
        </div>
      </footer>
    </div>
